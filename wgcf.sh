...
PROJECT_NAME='wgcf'
GH_API_URL='p.ff11.tk/https://api.github.com/repos/ViRb3/wgcf/releases/latest'
...
DOWNLOAD_URL="p.ff11.tk/"$(curl -fsSL ${GH_API_URL} | grep 'browser_download_url' | cut -d'"' -f4 | grep "${FILE_KEYWORD}")
