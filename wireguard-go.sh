...
GH_API_URL='p.ff11.tk/https://api.github.com/repos/P3TERX/wireguard-go-builder/releases/latest'
...
DOWNLOAD_URL="p.ff11.tk/$(curl -fsSL ${GH_API_URL} | grep 'browser_download_url.*gz"' | cut -d'"' -f4 | grep "${FILE_KEYWORD}")"
